                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">Return Pembelian</li>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form method="POST" action="<?= site_url('retur/pembelian/store') ?>" class="form-horizontal form-element ">
                                <div class="box-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="id_pembelian" class="col-sm-2 control-label">Pembelian</label>
                                        <div class="col-sm-10">
                                ...
                                <div class="box-footer">
                                    ...
                                    <a href="<?= site_url('retur/pembelian') ?>" class="btn btn-rounded btn-danger pull-right mr-2 mb-2">Batalkan</a>
                                </div>
                                <!-- /.box-footer -->
                            </form>
                        </div>
...
<?php $this->load->view('transaksi/retur_pembelian/script'); ?>